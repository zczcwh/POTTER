...
# Model parameters
parser.add_argument('--model', default='poolattnformer_s12', type=str, metavar='MODEL',
                    help='Name of model to train (default: "poolattnformer_s12"')
...
parser.add_argument('--drop-block', type=float, default=0.1, metavar='PCT',
